...
cat testInput10k.txt | ./second 10 | wc -l
cat testInput10k.txt | ./second 50 | wc -l
cat testInput10k.txt | ./second 100 | wc -l
cat testInput10k.txt | ./second 250 | wc -l
cat testInput10k.txt | ./second 500 | wc -l
echo
make clean;
echo